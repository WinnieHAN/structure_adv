# test
python barchybrid/src/parser.py --predict --outdir output --test /home/hanwj/Code/PycharmProjects/NeuroNLP2/data/ptb/test.conllu --extrn sskip.100.vectors --model pretrained/model2/barchybrid.model20 --params pretrained/model2/params.pickle
# train
