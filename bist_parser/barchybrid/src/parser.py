    ...
    if not options.predictFlag:
        ...
        for epoch in xrange(options.epochs):
            ...
            if not conllu:
                ...
                os.system('python barchybrid/src/utils/evaluation_script/conll17_ud_eval.py -v -w barchybrid/src/utils/evaluation_script/weights.clas ' + options.conll_dev + ' ' + devpath + ' > ' + devpath + '.txt')
        ...
        if not conllu:
            ...
            os.system('python barchybrid/src/utils/evaluation_script/conll17_ud_eval.py -v -w barchybrid/src/utils/evaluation_script/weights.clas ' + options.conll_test + ' ' + tespath + ' > ' + tespath + '.txt')
