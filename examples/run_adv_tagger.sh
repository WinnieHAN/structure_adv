...
PORT=10045
PREFIX='/home/zhanglw/code/structure_adv/b64_lr5e4_mpe1_noppl_'
...
/home/zhanglw/bin/anaconda3/envs/advbiaf/bin/python  examples/run_adv_tagger.py --cuda --mode LSTM --num_epochs 30 \
