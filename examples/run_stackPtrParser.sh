#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=0 /path/to/python2/envs/python examples/StackPointerParser.py --cuda --mode FastLSTM --num_epochs 1000 --batch_size 32 --decoder_input_size 256 --hidden_size 512 --encoder_layers 3 --decoder_layers 1 \
 ...
 --model_path "models/parsing/stack_ptr1/" --model_name 'network.pt'
