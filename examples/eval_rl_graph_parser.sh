...
PORT=10060
PREFIX='/path/to/project/root/parsing_eval_'

export CUDA_VISIBLE_DEVICES=0

/path/to/python3/envs/python seq2seq_rl/bertscore_ppl_server.py --language_code en --port $PORT --prefix $PREFIX &

/path/to/python2/envs/python examples/eval_rl_graph_parser.py --cuda --mode FastLSTM \
...
--rl_finetune_seq2seq_load_path /path/to/seq2seq/model --rl_finetune_network_load_path /path/to/network/model/ \
