...
#/home/zhanglw/bin/anaconda3/envs/bertscore/bin/python seq2seq_rl/bertscore_ppl_server.py --language_code zh --port $PORT &
#
#/home/zhanglw/bin/anaconda3/envs/advbiaf/bin/python examples/run_rl_graph_parser.py --cuda --mode FastLSTM --num_epochs 80 --batch_size 1 --hidden_size 512 \
...
/home/zhanglw/bin/anaconda3/envs/bertscore/bin/python seq2seq_rl/bertscore_ppl_server.py --language_code en --port $PORT &

/home/zhanglw/bin/anaconda3/envs/advbiaf/bin/python examples/run_rl_graph_parser.py --cuda --mode FastLSTM \
--num_epochs 1000 --batch_size 5 --hidden_size 5 --num_layers 3 --pos_dim 10 --char_dim 10 --num_filters 10 \
